...
const Home = () => {
    ...
    const returnDetails = () => {
        return (
            <div className="p-2 p-md-4 d-flex flex-column" style={{ backgroundColor: 'rgb(240, 242, 242)', minHeight: '100vh' }} >
                <div className="d-flex flex-row justify-content-start align-items-center mb-3">
                    ...
                    <span className="app-brand-text fw-bolder ms-2" style={{ fontSize: '30px', color: 'rgb(6, 31, 92)' }} >OHOINDIA</span>
                </div>
        ...
        isformOpen ? (
            <div className="p-2 p-md-4 d-flex flex-column" style={{ backgroundColor: 'rgb(240, 242, 242)', minHeight: '100vh' }} >
                ...
                <div className="card p-3 text-start">
                    ...
                    <h4 className='mb-3'>{formData.FullName}</h4>
